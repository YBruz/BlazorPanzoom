...
public record PanzoomOptions : IZoomOnlyOptions, IPanOnlyOptions, IMiscOnlyOptions
{
	...
	private static readonly ElementReference[] EmptyExcludedReferences = [];
	private static readonly PanzoomOptions Default = new();
	private readonly Contain? _contain;

	public IEnumerable<ElementReference> GetExcludeOrDefault(IEnumerable<ElementReference>? elementReferences = null)
	{
